...
//                })
                ...
                .Default(() =>
                {
                    ...
                    //result.AppendLine("\r\n");
                    result.AppendLine(
                        "您还可以发送【位置】【电话】等信息，查看不同消息。\r\n");
                    defaultResponseMessage.Content = result.ToString();
                    return defaultResponseMessage;
                })

                .Keywords(new[] { "电话", "联系", "联系方式","咨询" }, () =>
                {
                    defaultResponseMessage.Content = "杭州里德通信有限公司欢迎您来电咨询: \r\n0571-88650336";
                    return defaultResponseMessage;
                })

                .Keywords(new[] { "位置", "坐标", "地址","公司地址","联系地址" }, () =>
                {
                    defaultResponseMessage.Content = "杭州里德欢迎您光临指导:\r\n里德电子地址：浙江省杭州市滨江区楚天路123号 \r\n\r\n里德通信地址：浙江省杭州市桐庐县董家路188号";
                    return defaultResponseMessage;
                })

                //“网站地址”接口测试
                .Keywords(new[] { "网址", "网站", "链接","网站地址","www" }, () =>
                    {
                        defaultResponseMessage.Content = "杭州里德通信：http://www.hzlde.com";
                        return defaultResponseMessage;
                    });
                ////正则表达式
                //.Regex(@"^\d+#\d+$", () =>
